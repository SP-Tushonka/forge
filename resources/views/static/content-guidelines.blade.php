<x-layouts::static-toc>
    ...
    <x-slot name="tableOfContents">
        ...
        >
            <x-table-of-contents-subitem href="#file-format-standards">File Format
                Standards</x-table-of-contents-subitem>
            <x-table-of-contents-subitem href="#mod-types-requirements">Mod Types and
                Requirements</x-table-of-contents-subitem>
        </x-table-of-contents-item>
        <x-table-of-contents-item
            href="#semantic-versioning"
            title="Semantic Versioning Requirements"
        >
            <x-table-of-contents-subitem href="#understanding-semver">Understanding Semantic
                Versioning</x-table-of-contents-subitem>
            <x-table-of-contents-subitem href="#version-constraints">Semantic Version
                Constraints</x-table-of-contents-subitem>
            <x-table-of-contents-subitem href="#implementation-requirements">Implementation
                Requirements</x-table-of-contents-subitem>
        </x-table-of-contents-item>
        <x-table-of-contents-item
        ...
        >
            <x-table-of-contents-subitem href="#functional-requirements">Functional
                Requirements</x-table-of-contents-subitem>
            <x-table-of-contents-subitem href="#code-quality">Code Quality Standards</x-table-of-contents-subitem>
        </x-table-of-contents-item>
        <x-table-of-contents-item
            href="#executable-security"
            title="Executable Files and Security"
        >
            <x-table-of-contents-subitem href="#executable-requirements">Executable Content
                Requirements</x-table-of-contents-subitem>
            <x-table-of-contents-subitem href="#network-communication">Network
                Communication</x-table-of-contents-subitem>
        </x-table-of-contents-item>
        <x-table-of-contents-item
            href="#licensing-permissions"
            title="Content Licensing and Permissions"
        >
            <x-table-of-contents-subitem href="#license-requirements">License Requirements</x-table-of-contents-subitem>
            <x-table-of-contents-subitem href="#attribution-requirements">Attribution
                Requirements</x-table-of-contents-subitem>
        </x-table-of-contents-item>
        <x-table-of-contents-item
            href="#special-categories"
            title="Special Content Categories"
        >
        ...
        <x-table-of-contents-item
            href="#file-hosting"
            title="File Hosting and Distribution"
        />
        <x-table-of-contents-item
            href="#violation-consequences"
            title="Violation Consequences and Appeals"
        />
    </x-slot>
    ...
    <h4 id="what-these-guidelines-cover">What These Guidelines Cover:</h4>
    <ul>
    ...
    <h4 id="archive-requirements">Archive Requirements:</h4>
    ...
    <ul>
        <li>All mods must be packaged in either 7-Zip format (<code>.7z</code>) or ZIP format (<code>.zip</code>) to
            ensure consistent compression and extraction behavior across different operating systems and by different
            tooling</li>
        <li>Archives must contain all necessary files for mod functionality, ensuring users receive complete packages
    ...
    <h4 id="description-requirements">Description Requirements:</h4>
    ...
    <h4 id="client-mods-bepinex-plugins">Client Mods (BepInEx Plugins):</h4>
    ...
    <ul>
        ...
        <li>Compiled files must be included and ready for immediate use without requiring users to build from source
        </li>
        <li>
            The <code>[BepInPlugin]</code> attribute must be present on the class that extends
            <code>BaseUnityPlugin</code> with the following properties:
            <ul>
                <li><strong>GUID ("com.username.modname"):</strong> Must match the GUID entered when uploading to The
                    Forge and the GUID in the server mod (if one exists) to ensure proper mod identification</li>
                <li><strong>Mod Name ("Username-ModName"):</strong> Must start with your username, followed by a dash,
                    followed by the mod name, with only letters, numbers, and a single dash allowed for consistent
                    naming conventions</li>
                <li><strong>Version ("1.2.3"):</strong> Must be a valid semantic version and match the version in the
                    server mod (if one exists) to maintain synchronization</li>
            </ul>
            <pre><code class="language-csharp">[BepInPlugin("com.username.modname", "Username-ModName", "1.2.3")]</code></pre>
        </li>
    </ul>
    <h4 id="server-mods-spt-v3-x-and-below-node-js">Server Mods (SPT v3.x and below - Node.js):</h4>
    ...
    <ul>
        <li>Files must be properly packaged as JavaScript or TypeScript following SPT server mod structure and
            conventions</li>
        <li>Modifications should alter data in memory during runtime rather than directly editing core SPT files to
            maintain system stability</li>
        <li>
            The <code>package.json</code> file must include required properties:
            <ul>
                <li><strong>version</strong>: Must be a valid semantic version and match the client mod version (if one
                    exists) to ensure compatibility</li>
                <li><strong>sptVersion</strong>: Semantic version constraint specifying SPT compatibility range for
                    automatic compatibility checking</li>
            </ul>
            <pre><code class="language-json">{
  "version": "1.2.3",
  "sptVersion": "~3.11"
}</code></pre>
            <em>See <a href="https://github.com/sp-tarkov/server-mod-examples/">mod examples</a> for more
                information</em>
        </li>
    </ul>
    <h4 id="server-mods-spt-v4-0-c">Server Mods (SPT v4.0+ - C#):</h4>
    ...
    <ul>
        ...
        <li>Modifications should follow SPT server mod structure and conventions, modifying data in memory during
            runtime rather than editing core SPT files directly</li>
        <li>
            Mod version must be specified in two locations for consistency:
            <ul>
                <li><code>.csproj</code> file: <code>&lt;Version&gt;1.2.3&lt;/Version&gt;</code> tag for build system
                    integration</li>
                <li>
...
public override SemanticVersioning.Range SptVersion { get; } = new("4.0.0");</code></pre>
    ...
    <h4 id="configuration-presets">Configuration Presets:</h4>
    ...
    <ul>
        <li>Files may include JSON, XML, or other configuration formats with significant modifications to default
            settings</li>
    ...
    <ul>
        <li>Executable files (<code>.exe</code>, <code>.cmd</code>, <code>.bat</code>, etc.) must be provided in
            ready-to-use format</li>
    ...
    <h4 id="basic-semver-format-major-minor-patch">Basic SemVer Format: <code>MAJOR.MINOR.PATCH</code></h4>
    <p>Each component serves a specific purpose in communicating the type of changes included in a release. The MAJOR
        ...
        increments for backward-compatible bug fixes and minor improvements.</p>
    ...
    <h4 id="when-to-increment-version-components">When to Increment Version Components:</h4>
    <p>Increment the MAJOR version when making incompatible changes that require users to modify their configurations,
        ...
        configure it.</p>
    <p>Increment the MINOR version when adding new features that maintain compatibility with existing configurations,
        when introducing new configuration options that have sensible defaults, when adding optional dependencies that
        enhance but do not require existing functionality, or when making significant improvements that do not break
        existing usage patterns.</p>
    <p>Increment the PATCH version when fixing bugs without changing functionality, when making performance
    ...
    <h4 id="common-constraint-patterns">Common Constraint Patterns:</h4>
    ...
    <p>The caret constraint (<code>^1.2.3</code>) allows minor and patch-level changes within the same major version,
        accepting <code>1.2.3</code>, <code>1.3.0</code>, and <code>1.9.5</code> but rejecting <code>2.0.0</code>. This
        constraint is appropriate when you can handle new features but not breaking changes.</p>
    <p>Exact version matching (<code>1.2.3</code>) requires precisely that version and no other. This approach provides
        ...
        versions.</p>
    <h4 id="practical-application-in-mod-development">Practical Application in Mod Development:</h4>
    ...
    <h4 id="version-declaration-consistency">Version Declaration Consistency:</h4>
    ...
    <h4 id="spt-compatibility-constraints">SPT Compatibility Constraints:</h4>
    ...
    <h4 id="version-validation">Version Validation:</h4>
    ...
    <h4 id="testing-standards">Testing Standards:</h4>
    ...
    <p>Error handling must be implemented gracefully to manage missing dependencies without causing system crashes or
        ...
        technical detail.</p>
    <h4 id="logging-standards">Logging Standards:</h4>
    <p>Logging functionality should provide pertinent information to end users while maintaining clean, readable console
        ...
        difficult.</p>
    <p>Restricted logging practices include any form of ASCII or Unicode art or logos that clutter console output,
        multi-line mod author or team credits that should be reserved for documentation rather than runtime logs, and
    ...
    <h4 id="version-watermark">Version Watermark:</h4>
    ...
    <h4 id="ai-generated-content-policy">AI-Generated Content Policy:</h4>
    <p>The Forge does not accept mods that have been substantially or entirely written by AI coding agents. AI models
        ...
        compatibility issues that AI-generated code cannot adequately address.</p>
    <p>Mod authors must fully understand their code's functionality, implementation details, and potential security
        implications because they are responsible for how their modifications affect other users' systems and gameplay
        experience. When users download a mod, they trust that the author has thoroughly reviewed, tested, and validated
        every aspect of the code's behavior.</p>
    <p>Using AI tools for basic code completion, syntax assistance, or generating small utility functions is acceptable
        when the author reviews, understands, and takes full responsibility for the generated code. However, using AI to
        write entire features, complex game modifications, or substantial portions of mod functionality is prohibited.
        The distinction lies in whether the author maintains complete understanding and control over their code versus
        relying on AI to generate logic they cannot fully comprehend or validate.</p>
    ...
    <h4 id="mandatory-requirements">Mandatory Requirements:</h4>
    ...
    <ul>
        <li>All <code>.dll</code>, <code>.exe</code>, and compiled binary files must include a link to publicly
            accessible source code</li>
        <li>Source code must be available through established platforms (GitHub, GitLab, etc.) that provide proper
            version control and transparency</li>
        <li>Repositories must contain the exact code used to build the executable, with no hidden or proprietary
            components</li>
        <li>Build instructions must be provided in the repository to enable independent verification of the compilation
            process</li>
    </ul>
    <h4 id="security-verification">Security Verification:</h4>
    <ul>
    ...
    <h4 id="prohibited-executable-behavior">Prohibited Executable Behavior:</h4>
    <ul>
    ...
    <h4 id="allowed-network-activity">Allowed Network Activity:</h4>
    ...
    <h4 id="required-disclosure">Required Disclosure:</h4>
    <ul>
    ...
    <h4 id="prohibited-network-activity">Prohibited Network Activity:</h4>
    <ul>
        ...
        <li>Automatic downloading of additional content without consent can introduce malware or unwanted modifications
        </li>
    ...
    <h4 id="acceptable-licenses">Acceptable Licenses:</h4>
    ...
    <ul>
        <li>MIT, Apache 2.0, GPL, BSD, and other OSI-approved licenses provide established legal frameworks for code
            distribution</li>
        <li>Creative Commons licenses are appropriate for non-code content including documentation, artwork, and media
            files</li>
        <li>Public domain dedication is acceptable for content where authors wish to relinquish all rights</li>
    </ul>
    <h4 id="license-documentation">License Documentation:</h4>
    <ul>
        ...
        <li>Authors must understand the implications of their chosen license, particularly regarding commercial use and
            derivative works</li>
    </ul>
    ...
    <p>Submission of existing user-contributed content without obtaining permission from the original authors is
        strictly prohibited. This applies regardless of whether modifications have been made or if the content is being
        redistributed as-is. The burden of obtaining proper authorization rests entirely with the person submitting
        derivative or redistributed content.</p>
    <p>Proper credit to original authors must be provided unless the authors have explicitly specified that attribution
    ...
    <h4 id="when-using-others-work">When Using Others' Work:</h4>
    ...
    <h4 id="prohibited-content">Prohibited Content:</h4>
    ...
    <h4 id="mature-themes">Mature Themes:</h4>
    <ul>
    ...
    <h4 id="strictly-prohibited-modifications">Strictly Prohibited Modifications:</h4>
    ...
    <h4 id="cheat-like-mods">Cheat-Like Mods:</h4>
    ...
    <h4 id="allowed-development-tools">Allowed Development Tools:</h4>
    <ul>
    ...
    <p>Permission tracking becomes unmanageable as compilations require explicit consent from every included mod author.
        Compatibility maintenance is equally problematic since individual mods within a compilation update
        independently, often breaking compatibility with other included components. Version synchronization across
        multiple mods with different release schedules creates constant conflicts that require continuous manual
        intervention.</p>
    <p>The Forge encourages users to install individual mods directly from their original creators to ensure they
        receive proper updates, support, and compatibility verification. This approach guarantees that users get the
    ...
    <h4 id="prohibited-commercial-activities">Prohibited Commercial Activities:</h4>
    <ul>
    ...
    <h4 id="permitted-donation-links">Permitted Donation Links:</h4>
    ...
    <ul>
        ...
        <li>All mod features, downloads, and updates must remain equally available to all users regardless of donation
            status</li>
    ...
    <h4 id="community-standards">Community Standards:</h4>
    ...
    <h4 id="consequences-for-violations">Consequences for Violations:</h4>
    ...
    <h3 id="download-link-requirements">8.1 Download Link Requirements</h3>
    <h4 id="direct-download-links-ddl-required">Direct Download Links (DDL) Required:</h4>
    ...
    <ul>
        ...
        <li>The download link must confirm that the file is either a 7-zip archive (.7z) or ZIP archive (.zip) as
            required by our archive standards</li>
        <li>Links must remain accessible indefinitely to ensure long-term availability</li>
    </ul>
    <h4 id="prohibited-link-types">Prohibited Link Types:</h4>
    <p>Any download link that does not meet the direct download requirement is prohibited. This includes but is not
        ...
        downloading.</p>
    <h4 id="recommended-hosting">Recommended Hosting:</h4>
    ...
    <h3 id="guideline-violations">9.1 Guideline Violations</h3>
    <h4 id="minor-violations">Minor Violations:</h4>
    ...
    <p><strong>Consequences:</strong> Requests for corrections with guidance, temporary content hiding until issues are
        resolved</p>
    <h4 id="major-violations">Major Violations:</h4>
    ...
    <h4 id="improvement-opportunities">Improvement Opportunities:</h4>
    <ul>
    ...
    <h2 id="content-guidelines-summary">Content Guidelines Summary</h2>
    <h4 id="essential-requirements">Essential Requirements:</h4>
    <ul>
    ...
    <h4 id="summary-quality-standards">Quality Standards:</h4>
    <ul>
    ...
    <h4 id="summary-prohibited-content">Prohibited Content:</h4>
    <ul>
    ...
    <p><em>These Content Guidelines work together with our <a href="{{ route('static.terms') }}">Terms of Service</a>,
