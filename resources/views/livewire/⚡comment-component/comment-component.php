...
new class extends Component
{
    ...
    public function updateComment(int $commentId): void
    {
        ...
        // Preserve the prior spam_status so a clean comment doesn't flicker out of view during the recheck window;
    ...
    public function deleteComment(Comment|int|null $commentId = null): void
    {
        ...
        $isWithinTimeLimit = $comment->created_at && $comment->created_at->diffInMinutes(now()) <= $editTimeLimit;
    ...
    public function loadDescendants(int $commentId): void
    {
        ...
        /** @var Collection<int, Comment> $descendants */
    ...
    public function with(): array
    {
        ...
        /** @var Collection<int, Comment> $visibleRootComments */
