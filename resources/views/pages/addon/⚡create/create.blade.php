                    ...
                    <div class="bg-gray-900 px-4 py-5 shadow-sm sm:rounded-tl-md sm:rounded-tr-md sm:p-6">
                        <div class="grid grid-cols-6 gap-8">
                            ...
                            <flux:field class="col-span-6">
                                ...
                                <flux:description>
                                    {{ __('Optionally upload an image to use as the addon\'s thumbnail. This will be displayed on the addon page and in search results. The image should be square JPG, PNG, GIF, WebP, or AVIF, no larger than 2MB.') }}
                                </flux:description>
