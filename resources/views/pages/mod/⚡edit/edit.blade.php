        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="flex justify-between md:col-span-1">
                <div class="px-4 sm:px-0">
                    ...
                    <p class="my-2 text-sm text-sm/6 text-gray-400">You may update your mod details
                    ...
                    <div class="bg-gray-900 px-4 py-5 shadow-sm sm:rounded-tl-md sm:rounded-tr-md sm:p-6">
                        <div class="grid grid-cols-6 gap-8">
                            ...
                            <flux:field class="col-span-6">
                                ...
                                <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                                    ...
                                    <x-image-crop-upload
                                        ...
                                        @class(['h-full', 'lg:col-span-2' => !$thumbnail && !$mod->thumbnail])
                                    />
                                </div>
                            ...
                            >
                                ...
                                <flux:description>
                                    {{ __('A unique identifier in reverse domain notation that matches the GUID in your mod files. Stored lowercase, matched case-insensitively.') }}
